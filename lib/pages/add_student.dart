...
class _AddStudentScreenState extends State<AddStudentScreen> {
  ...
  Future<void> addStudent() async {
    ...
    final String studentClass = classController.text.trim();

    if (name.isEmpty || studentId.isEmpty || studentClass.isEmpty) {
    ...
    final ParseObject student = ParseObject('Students')
      ..set('name', name)
